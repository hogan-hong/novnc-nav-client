...
- 设置剪贴板（自动读取系统剪切板，同步到所有设备）

### 客户端增强功能

- 自动缩放：检测屏幕分辨率，按 2560x1440 设计基准自动计算缩放比例，小屏笔记本自动缩小
- 窗口最大化：所有窗口（导航页+控制窗口）打开即最大化
- 控制窗口内导航：点击导航栏链接在当前窗口内跳转，不新建窗口
- 手动缩放快捷键：Ctrl+= 放大 / Ctrl+- 缩小 / Ctrl+0 重置为自动
- 剪切板一键同步：点击"设置剪切板"直接读取系统剪切板内容，同步到所有 iframe，无需手动输入
